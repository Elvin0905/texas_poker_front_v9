...
export class LobbyScene extends Phaser.Scene {
  ...
  setSettingsModalVisible(visible) {
    ...
    this.settingsPanelBorder?.setVisible(visible);
    this.settingsPanelGfx?.setVisible(visible);
    this.settingsTitleLabel?.setVisible(visible);
    this.settingsTitleText?.setVisible(visible);
    this.settingsCloseButton?.setVisible(visible);
  ...
  applyLayout() {
    ...
    this.settingsCloseButton?.setPosition?.(layout.centerX + 232, sp_top + 24 + dy);
