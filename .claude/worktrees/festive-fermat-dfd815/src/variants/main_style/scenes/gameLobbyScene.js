...
export class GameLobbyScene extends Phaser.Scene {
  ...
  create() {
    ...
    const addOnBtn = this.add.image(316, 114, "choose_game", "add on").setDisplaySize(37, 38);
    bindImageButton(this, addOnBtn, { onClick: () => this.showUnderConstruction() });
    this.roomScrollContainer.add(addOnBtn);
